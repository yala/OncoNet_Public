...
def parse_args():
    ...
    parser.add_argument('--train_years', nargs='*', type=int, default=[2014, 2013, 2009], help='The list of years to draw training data for mammo risk datasets.')
    parser.add_argument('--dev_years', nargs='*', type=int, default=[2010, 2011, 2012, 2015], help='The list of years to draw dev data for mammo risk datasets.')
    parser.add_argument('--test_years', nargs='*', type=int, default=[2010, 2011, 2012, 2015], help='The list of years to draw test data for mammo risk datasets.')
    ...
    parser.add_argument('--input_dim', type=int, default=3, help='Input dim for 2stage models. [default:3]')
    ...
    parser.add_argument('--cache_path', type=str, default='/tmp_imgs/', help='dir to cache images.')
    ...
    parser.add_argument('--use_second_order_risk_factor_features', action='store_true', default=False, help='Whether to only use 2nd order risk factor features.')
    ...
    parser.add_argument('--use_permissive_cohort', action='store_true', default=False, help='Allow exams with cancer within 1 year before and after.')
