...
RESULT_KEY_STEMS = ['{}_loss', '{}_reg_loss', '{}_accuracy', '{}_auc', '{}_precision', '{}_recall', '{}_f1']
...
if __name__ == "__main__":
    ...
    for _ in range(len(job_list)):
        ...
        for k in result_keys:
            if ( 'test_stats' in result_dict and k in result_dict['test_stats'] and len(result_dict['test_stats'][k])>0) or (result_dict['train'] and k in result_dict['epoch_stats'] and len(result_dict['epoch_stats'][k])>0):
